...
info: 'A design concept for an AR try-on experience — research and an interactive prototype exploring how shoppers judge texture, fit and colour online.'
description: 'OUTFITS YOU is a design concept for an AR try-on experience, taken from user research to an interactive prototype. It explores how people could assemble outfits and build a collection digitally, and what would help them find styles that suit a particular occasion. Research and prototype — not implemented.'
