...
info: 'A design concept for AR language learning — memorising everyday phrases in immersive, real-world contexts.'
description: 'Multi-Multi is a design concept for an AR language-learning app: practising vocabulary and phrases in everyday scenarios through map-based exploration, object recognition and memory-associative techniques. Concept, prototype and feasibility study — the object-recognition approach was checked with engineers rather than implemented.'
role: 'UX Designer'
timeline: '6 Week'
completed: '10/2021'
