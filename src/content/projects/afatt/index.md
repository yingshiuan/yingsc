...
![culture-preferences](./culture-and-preferences.png)

<div class="font-bold text-lg">Cultural integrity with local preferences</div>
<div>Blend modern design trends with color and cultural elements to create a contemporary yet authentic atmosphere that resonates with both Asian and Swiss clients.</div>
</div>

<div class="space-y-4">

![multi-dietary](./multi-dietary.jpg)

<div class="font-bold text-lg">Multilingual and Dietary-friendly</div>
<div>Provide dietary options to accommodate various preferences, with descriptions written in multiple languages.​</div>
</div>

<div class="space-y-4">

![Intuitive and Inclusive](./Intuitive-and-Inclusive.jpg)

<div class="font-bold text-lg">Intuitive navigation and Inclusive experience</div>
<div>Ensure hierarchical readability, appropriate font sizes, and dish images to help customers easily find their favorite dishes.</div>
</div>
</div>
...
![afatt-information-architecture](./ia.png)
